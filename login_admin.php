...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("SELECT id, full_name, password FROM users WHERE phone_number = ? AND role = 'admin'");
    ...
    $error = "Maklumat tidak sah atau bukan akaun pentadbir.";
}
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <title>Log Masuk Admin - VouteX KKJR</title>
    ...
    <style>
        ...
        .login-card {
            ...
            border-radius: 25px;
            padding: 50px 40px;
            box-shadow: 0 10px 50px rgba(233, 69, 96, 0.5), 0 0 30px rgba(255, 215, 0, 0.2);
            max-width: 420px;
            width: 100%;
...
<body>
    <div class="login-card">
        ...
        <div class="text-center mt-4">
            <a href="./login_pengguna.php" class="link-text">Log Masuk Pengguna</a>
        </div>
    </div>
</body>
</html>
